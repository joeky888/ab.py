...
parser.add_argument("-u", "--url", help="Set URL (default: http://www.example.com)", dest="url", default="http://www.example.com")
...
parser.add_argument("-H", "--header", help="Set headers (default: Content-Type: application/json;User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:59.0) Gecko/20100101 Firefox/59.0)", dest="header", default="Content-Type: application/json;User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:59.0) Gecko/20100101 Firefox/59.0")
    ...
    "content": [ \
        { \
            "data": { \
                ...
                "domain": "com.a.robotnewsskill", \
                "voconLearnFlag": false, \
                "continuousSpeech": false, \
                "originalSentence": "Stock news", \
                "version": "0,0,22", \
                "output_context": [], \
                "isWebSkill": true, \
                "Phrase": [], \
